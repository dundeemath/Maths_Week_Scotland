...
format: html
code-fold: True
categories: [Geometry, Permutations, Group theory]
resources:
...
![An equilateral triangle](equilateral_triangle_elegant_arrow.png){height="3.0in"}

![A trifold-symmetric leaf](trifold_leaf_clipped_veins.png){height="3.0in"}
