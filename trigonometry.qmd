...
![](bg_tall_object.jpg){width="1.8in" fig-pos="H"}
...
4. Stop looking at your phone and adjust your position by walking forwards or backwards. Repeat steps 1-4 until the treetop lines up exactly along the diagonal line.
...
<style>
  ...
  @media (max-width: 520px) {
    #tree-app { gap: 8px; }
    #tree-app .sidebar { flex-basis: 100%; }
...
<div id="tree-app">
  <div class="sidebar">
    ...
    <label for="tree-pacelen">Your pace length (cm): <strong id="tree-pacelen-val">75</strong></label>
    <input id="tree-pacelen" type="range" min="20" max="150" step="1" value="75">
...
(function () {
  ...
  function renderSummary() {
    ...
    lines.push("<strong>Your estimated height:</strong> " + d.estM.toFixed(1) + " m");
    if (revealed) {
