...
By measuring the walking distance ot the base of the tree we can estimate the height using trigonometry.
...
3. Sight across the phone's diagonal and imagine a line extending towards the top of the tree.
