...
Note: this simulation runs entirely in your browser (via Pyodide/WebAssembly) once the page has finished loading -- there's no server involved, so nothing you do here is sent anywhere.
